...
public class PrzelicznikWalutFinal {
	...
	private JFormattedTextField txtKwotaZlote;
	private JFormattedTextField txtKwotaWaluta;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PrzelicznikWalutFinal window = new PrzelicznikWalutFinal();
	...
	private void initialize() {
		...
		txtKwotaZlote = new JFormattedTextField(format);
		...
		txtKwotaWaluta = new JFormattedTextField(format);
